...
const ToolInputSchema = ToolSchema.shape.inputSchema as unknown as TSchema;
...
server.setRequestHandler(ListToolsRequestSchema, async () => {
  ...
  const allTools = [
    // Read-only tools
    {
      ...
      inputSchema: ReadFileArgsSchema as ToolInput,
    },
    {
      ...
      inputSchema: ReadMultipleFilesArgsSchema as ToolInput,
    },
    {
      name: "list_directory",
      description:
      ...
      inputSchema: ListDirectoryArgsSchema as ToolInput,
    },
    {
      name: "directory_tree",
      description:
      ...
      inputSchema: DirectoryTreeArgsSchema as ToolInput,
    },
    {
      name: "search_files",
      description:
      ...
      inputSchema: SearchFilesArgsSchema as ToolInput,
    },
    {
      ...
      inputSchema: FindFilesByExtensionArgsSchema as ToolInput,
    },
    {
      name: "get_file_info",
      description:
      ...
      inputSchema: GetFileInfoArgsSchema as ToolInput,
    },
    {
    ...
    // New get_permissions tool
    {
      ...
      description:
        ...
        "attempting them.",
      inputSchema: GetPermissionsArgsSchema as ToolInput,
    },
    ...
    // Write tools (filtered based on permissions)
    {
      ...
      inputSchema: WriteFileArgsSchema as ToolInput,
    },
    {
      name: "modify_file",
      description:
    ...
    },
    {
      ...
      description:
        ...
        "Only works within allowed directories. " +
        "This tool requires the --allow-edit permission.",
      inputSchema: EditFileArgsSchema as ToolInput,
    },
    {
      ...
      description:
        ...
        "Only works within allowed directories. " +
        "This tool requires the --allow-create permission.",
      inputSchema: CreateDirectoryArgsSchema as ToolInput,
    },
    {
      name: "move_file",
      description:
      ...
      inputSchema: MoveFileArgsSchema as ToolInput,
    },
    {
      name: "rename_file",
      description:
      ...
      inputSchema: RenameFileArgsSchema as ToolInput,
    },
    {
      name: "xml_query",
      description:
      ...
      inputSchema: XmlQueryArgsSchema as ToolInput,
    },
    {
      name: "xml_structure",
      description:
      ...
      inputSchema: XmlStructureArgsSchema as ToolInput,
    },
    {
      name: "xml_to_json",
      description:
      ...
      inputSchema: XmlToJsonArgsSchema as ToolInput,
    },
    {
      ...
      inputSchema: XmlToJsonStringArgsSchema as ToolInput,
    },
    {
      name: "delete_file",
      description:
      ...
      inputSchema: DeleteFileArgsSchema as ToolInput,
    },
    {
      ...
      description:
        ...
        "Only works within allowed directories. " +
        "This tool requires the --allow-delete permission.",
      inputSchema: DeleteDirectoryArgsSchema as ToolInput,
    },
    // JSON tools
    {
      name: "json_query",
      description:
        ...
        "The path must be within allowed directories.",
      inputSchema: JsonQueryArgsSchema as ToolInput,
    },
    {
      name: "json_structure",
      description:
        ...
        "The path must be within allowed directories.",
      inputSchema: JsonStructureArgsSchema as ToolInput,
    },
    {
      name: "json_filter",
      description:
      ...
      inputSchema: JsonFilterArgsSchema as ToolInput,
    },
    {
      name: "json_get_value",
      description:
      ...
      inputSchema: JsonGetValueArgsSchema as ToolInput,
    },
    {
      name: "json_transform",
      description:
      ...
      inputSchema: JsonTransformArgsSchema as ToolInput,
    },
    {
      name: "json_sample",
      description:
        ...
        "The path must be within allowed directories.",
      inputSchema: JsonSampleArgsSchema as ToolInput,
    },
    {
      name: "json_validate",
      description:
      ...
      inputSchema: JsonValidateArgsSchema as ToolInput,
    },
    {
      name: "json_search_kv",
      description:
        ...
        "The path must be within allowed directories.",
      inputSchema: JsonSearchKvArgsSchema as ToolInput,
    },
    {
      ...
      description:
        ...
        "Only searches within allowed directories.",
      inputSchema: RegexSearchContentArgsSchema as ToolInput,
    },
  ];
